...
race_and_gender$clinton_coef <- log(race_and_gender$clinton_numerator) - beta0
race_and_gender$trump_coef <- log(race_and_gender$trump_numerator) - beta0
...
education$clinton_coef <- log(education$clinton_numerator) - beta0
education$trump_coef <- log(education$trump_numerator) - beta0
...
fl_race_and_gender$clinton_coef <- log(fl_race_and_gender$clinton_numerator) - beta0
fl_race_and_gender$trump_coef <- log(fl_race_and_gender$trump_numerator) - beta0
