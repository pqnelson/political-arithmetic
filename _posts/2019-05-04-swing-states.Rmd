...
predicted <- predict(logit_mod, df_2012, type="response")
df_2012$bayes_predict <- predicted
predicted <- predict(lm0, df_2012, type="response")
df_2012$predict <- predicted

kable(df_2012[order(-df_2012$predict),c('state','predict', 'bayes_predict')], row.names = FALSE)
```
...
predicted <- predict(logit_mod, df_2016, type="response")
df_2016$bayes_predict <- predicted
predicted <- predict(lm0, df_2016, type="response")
df_2016$predict <- predicted
kable(df_2016[order(-df_2016$predict),c('state','predict', 'bayes_predict')], row.names = FALSE)
```
## Predicting 2020
