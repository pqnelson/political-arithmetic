...
```{r}
ky_senate <- kalman_senate(senate_raw, "Kentucky", election_date_2022)
save_senate_plot(ky_senate, "Kentucky")
```

```{r}
pa_senate <- kalman_senate(senate_raw, "Pennsylvania", election_date_2022)
transform_senate_result(nc_senate, "Pennsylvania")
save_senate_plot(nc_senate, "Pennsylvania")
```
