...
```{r}
predict_turnout_for_state <- function(state, coefs, census_data, election_2016) {
  numerator <- 0.0;
  denominator <- 0.0;
  ...
  relevant_coefs <- list("male" = c(beta_0,
                         ...
                         "age_18_24" = c(beta_0,
                                         ...
                                         coefs$state_age[[which(coefs$state_age=="18-24" & coefs$state_age$state==state),c("beta_age")]]),
                         "age_25_29" = c(beta_0,
                                         coefs$state[[which(coefs$state$state==state),c("beta_state")]],
                                         coefs$age[[which(coefs$age=="25-29"),c("beta_age")]],
                                         coefs$state_age[[which(coefs$state_age=="25-29" & coefs$state_age$state==state),c("beta_age")]]),
                         "age_30_39" = c(beta_0,
                                         coefs$state[[which(coefs$state$state==state),c("beta_state")]],
                                         coefs$age[[which(coefs$age=="30-39"),c("beta_age")]],
                                         coefs$state_age[[which(coefs$state_age=="30-39" & coefs$state_age$state==state),c("beta_age")]]),
                         "age_40_49" = c(beta_0,
                                         coefs$state[[which(coefs$state$state==state),c("beta_state")]],
                                         coefs$age[[which(coefs$age=="40-49"),c("beta_age")]],
                                         coefs$state_age[[which(coefs$state_age=="40-49" & coefs$state_age$state==state),c("beta_age")]]),
                         "age_50_64" = c(beta_0,
                                         coefs$state[[which(coefs$state$state==state),c("beta_state")]],
                                         coefs$age[[which(coefs$age=="50-64"),c("beta_age")]],
                                         coefs$state_age[[which(coefs$state_age=="50-64" & coefs$state_age$state==state),c("beta_age")]]),
                         "age_retirees" = c(beta_0,
                                            coefs$state[[which(coefs$state$state==state),c("beta_state")]],
                                            coefs$age[[which(coefs$age=="65 and older"),c("beta_age")]],
                                            coefs$state_age[[which(coefs$state_age=="65 and older" & coefs$state_age$state==state),c("beta_age")]]
                                            ),
                         "education_high_school_male" = c(beta_0,
                                                          coefs$state[[which(coefs$state$state==state),c("beta_state")]],
                                                          coefs$state_gender[[which(coefs$state_gender$state == state & coefs$state_gender$options == "Male"),c("beta_state_gender")]],
                                                          coefs$state_ed[[which(coefs$state_ed$state==state & coefs$state_ed$options=="High school or less"),c("beta_education")]],
                                                          coefs$ed[[which(coefs$ed$options=="High school or less"),c("beta_education")]]), 
                         ...
                         "education_some_college_male" = c(beta_0,
                                                          coefs$state[[which(coefs$state$state==state),c("beta_state")]],
                                                          coefs$state_gender[[which(coefs$state_gender$state == state & coefs$state_gender$options == "Male"),c("beta_state_gender")]],
                                                          coefs$state_ed[[which(coefs$state_ed$state==state & coefs$state_ed$options=="Some college"),c("beta_education")]],
                                                          coefs$ed[[which(coefs$ed$options=="Some college"),c("beta_education")]]), 
                         ...
                         "education_assoc_degree_male" = c(beta_0,
                                                          coefs$state[[which(coefs$state$state==state),c("beta_state")]],
                                                          coefs$state_gender[[which(coefs$state_gender$state == state & coefs$state_gender$options == "Male"),c("beta_state_gender")]],
                                                           0.5*(coefs$state_ed[[which(coefs$state_ed$state==state & coefs$state_ed$options=="Some college"),c("beta_education")]] + coefs$state_ed[[which(coefs$state_ed$state==state & coefs$state_ed$options=="College graduate"),c("beta_education")]]),
                                                          0.5*(coefs$ed[[which(coefs$ed$options=="Some college"),c("beta_education")]]+coefs$ed[[which(coefs$ed$options=="Some college"),c("beta_education")]])),
                         ...
                         "education_college_grad_male" = c(beta_0,
                                                          coefs$state[[which(coefs$state$state==state),c("beta_state")]],
                                                          coefs$state_gender[[which(coefs$state_gender$state == state & coefs$state_gender$options == "Male"),c("beta_state_gender")]],
                                                          coefs$state_ed[[which(coefs$state_ed$state==state & coefs$state_ed$options=="College graduate"),c("beta_education")]],
                                                          coefs$ed[[which(coefs$ed$options=="College graduate"),c("beta_education")]]), 
                         ...
                         "education_postgrad_male" = c(beta_0,
                                                          coefs$state[[which(coefs$state$state==state),c("beta_state")]],
                                                          coefs$state_gender[[which(coefs$state_gender$state == state & coefs$state_gender$options == "Male"),c("beta_state_gender")]],
                                                          coefs$state_ed[[which(coefs$state_ed$state==state & coefs$state_ed$options=="Postgraduate"),c("beta_education")]],
                                                          coefs$ed[[which(coefs$ed$options=="Postgraduate"),c("beta_education")]]), 
...
```{r}
predict_turnout <- function(exit_poll, election_2016, census_data) {
  ...
  for(state in unique(exit_poll$state)) {
    if (state != "nation") {
      print(state);
      results <- rbind(results, predict_turnout_for_state(state, coefs, census_data, election_data))
    }
  }
  results
}
